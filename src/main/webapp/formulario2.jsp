...
<body>
	...
	<form action="FormularioServlet" method="POST">
		...
		<p>
			...
			Selecciona lo que sabes: <br> <input type="checkbox" name="habilidades"
				value="java"> Java <input type="checkbox" name="habilidades" value="c">C/C++
			<input type="checkbox" name="habilidades" value="basic">Basic <input
				type="checkbox" name="habilidades" value="html">HTML <br>
		</p>
